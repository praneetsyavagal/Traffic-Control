...
#These lines establish the feed-forward part of the network used to choose actions
    ...
    W1= tf.Variable(tf.random_uniform([81,32],0,0.01))
    l1 = tf.matmul(inputs1,W1)
    W2 = tf.Variable(tf.random_uniform([32,3],0,0.01))
    ...
    with tf.Session() as sess:
        ...
        for i in range(num_episodes):
            ...
            while j < 1000:
                ...
                _,w1,w2 = sess.run([updateModel,W1,W2],feed_dict={inputs1:np.identity(81)[s:s+1],nextQ:targetQ})
                rAll += r
                s = s1
                phno = (phno + 1)%6
                if j==999:
